...
<body>
        ...
        <div class="layui-form">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select id="module" lay-filter="module">
						<option value="0">请选择模块</option>
						<option value="1">技术干货</option>
						<option value="2">读书感悟</option>
					</select>
				</div>
				<div class="layui-input-inline">
                    <select id="type">
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            var data = {"id" : id, "title" : title, "type" : type, "disp" : disp, "summary" : summary, "contentType" : contentType, "content" : content};
        ...
        layui.use('form', function(){
           ...
           form.on('select(module)', function(data){
        	   $.post("type.json", {module: data.value}, function(res){
                   $("#type").empty();
                   for(index in res.message.beans) {
                	   var type = res.message.beans[index];
