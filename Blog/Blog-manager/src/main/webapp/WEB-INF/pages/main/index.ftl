	...
	<body>
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-side layui-bg-black">
				<ul class="layui-nav layui-nav-tree">
					...
					<li class="layui-nav-item layui-nav-link">
						<a onclick="change('')"> 
							<i class="fa fa-puzzle-piece"></i> <cite>公告设置</cite>
						</a>
					</li>
					<li class="layui-nav-item layui-nav-link">
                           <a onclick="change('')"> 
                               <i class="fa fa-puzzle-piece"></i> <cite>权限设置</cite>
                           </a>
                       </li>
					<li class="layui-nav-item layui-nav-title"><a>文章设置</a></li>
					<li class="layui-nav-item layui-nav-link">
						<a onclick="change('')"> 
							<i class="fa fa-wpforms"></i> <cite>技术干货</cite>
						</a>
					</li>
					<li class="layui-nav-item layui-nav-link">
                           <a onclick="change('')"> 
                               <i class="fa fa-wpforms"></i> <cite>读书感悟</cite>
                           </a>
                       </li>
				</ul>
			</div>
			...
			<div class="layui-footer" style="padding-top: 15px;height:30px;">
			   <p class="center"><a href="https://heleeos.com/blog/" target="_black">Heleeos 博客</a> | 2017 © 李瑜  版权所有</p>
			</div>
		</div>
